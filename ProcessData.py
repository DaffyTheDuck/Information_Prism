...
class ProcessData:
    ...
    def split_text(self):
        if os.path.isdir("WebLoader"):
            ...
            for i in range(len(self.web_docs)):
            ...
            if os.path.isdir("WikiLoader"):
                ...
                for i in range(len(self.wiki_docs)):
                ...
                if os.path.isdir("YTTranscripts"):
                    ...
                    for i in range(len(self.yt_docs)):
    ...
    def embbed_docs(self):
        ...
        self.all_docs = self.final_wiki_docs +  self.final_user_pdf_docs
